...
mixin _$RouteModel {
  ...
  set port(String? value) => throw _privateConstructorUsedError;
  String? get sourcePort => throw _privateConstructorUsedError;
  set sourcePort(String? value) => throw _privateConstructorUsedError;
  String? get network => throw _privateConstructorUsedError;
  set network(String? value) => throw _privateConstructorUsedError;
  String? get source => throw _privateConstructorUsedError;
  set source(String? value) => throw _privateConstructorUsedError;
  String? get protocol => throw _privateConstructorUsedError;
  set protocol(String? value) => throw _privateConstructorUsedError;
  String? get outbound => throw _privateConstructorUsedError;
  set outbound(String? value) => throw _privateConstructorUsedError;
...
/// @nodoc
@JsonSerializable()
class _$RouteModelImpl with DiagnosticableTreeMixin implements _RouteModel {
  _$RouteModelImpl(
      {this.id,
      this.routeName,
      this.application,
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('outbound', outbound));
  }
...
abstract class _RouteModel implements RouteModel {
  factory _RouteModel(
      ...
      String? source,
      String? protocol,
      String? outbound}) = _$RouteModelImpl;
