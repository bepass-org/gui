          ...
          GroupForm(
            ...
            children: [
              InputEditable(
                ...
                defaultValue: '5',
                dialogType: FormEditableTypes.number,
                onChanged: (v) {},
              ),
              InputEditable(
                icon: Icons.http,
                ...
                dialogType: FormEditableTypes.url,
                onChanged: (v) {},
              ),
            ],
          ),
          ...
          GroupForm(
            ...
            children: [
              InputEditable(
                ...
                defaultValue: '1,2',
                dialogType: FormEditableTypes.numberRange,
                onChanged: (v) {},
              ),
              InputEditable(
                icon: Icons.code_off,
          ...
          GroupForm(
            ...
            children: [
              ...
              InputEditable(
                ...
                dialogType: FormEditableTypes.ip,
                onChanged: (v) {},
              ),
              InputEditable(
                ...
                title: 'Worker Port',
                defaultValue: '443',
                dialogType: FormEditableTypes.port,
                onChanged: (v) {},
              ),
            ],
          ),
